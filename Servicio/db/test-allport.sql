...
-- Insertar registro inicial para pruebas
INSERT INTO `alumnos-test` (
  `id_alumno`, `nombre_alumno`, `apellido1_alumno`, `apellido2_alumno`, `matricula-alumno`, `contrasena`, `email`, `apt1`, `ap2`, `ap3`, `ap4`, `ap5`, `ap6`, `estado`, `respuestas-alumno`
) VALUES (
  1,
  'Diego Uri',
  'Yamil',
